...
type Review struct {
	...
	RunnerRating    *int       `bun:"runner_rating" json:"runner_rating,omitempty" validate:"omitempty,min=1,max=5"`
	...
	RequesterID      *uuid.UUID `bun:"requester_id,type:uuid" json:"requester_id,omitempty"`
	RequesterRating  *int       `bun:"requester_rating" json:"requester_rating,omitempty" validate:"omitempty,min=1,max=5"`
	RequesterComment string     `bun:"requester_comment,nullzero" json:"requester_comment,omitempty"`
